...
public class SimpleAnnotatedTest extends AbstractSimpleAnnotatedTest {
    ...
    public void testPKFieldsInsert() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            assertThat(returnedRecord.getTimefield()).isEqualTo(record.getTimefield());
            assertThat(returnedRecord.getTimefield())
                    .isCloseTo(record.getTimefield(), byLessThan(1, ChronoUnit.SECONDS));
