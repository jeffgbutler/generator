...
public class UpdateByPrimaryKeySelectiveMethodGenerator extends AbstractJavaInterfaceMethodGenerator {
    ...
    public Optional<JavaMethodAndImports> generateMethodAndImports() {
        ...
        method.addBodyLines(
                fragmentGenerator.getSetEqualWhenPresentLinesForUpdateStatement(introspectedTable.getNonPrimaryKeyColumns(),
