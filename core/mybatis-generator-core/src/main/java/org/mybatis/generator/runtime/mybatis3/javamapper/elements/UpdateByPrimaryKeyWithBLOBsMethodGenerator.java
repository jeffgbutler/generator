...
public class UpdateByPrimaryKeyWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    protected UpdateByPrimaryKeyWithBLOBsMethodGenerator(Builder builder) {
        super(builder);
    }
    ...
    public boolean callPlugins(Method method, Interface interfaze) {
        return pluginAggregator.clientUpdateByPrimaryKeyWithBLOBsMethodGenerated(method, interfaze, introspectedTable);
    }
    ...
    public static class Builder extends AbstractGeneratorBuilder<Builder> {
        ...
        public UpdateByPrimaryKeyWithBLOBsMethodGenerator build() {
            return new UpdateByPrimaryKeyWithBLOBsMethodGenerator(this);
        }
    }
}
