...
import org.mybatis.generator.eclipse.core.merge.visitors.CompilationUnitType;
import org.mybatis.generator.eclipse.core.merge.visitors.GeneratedCodeDeletingVisitor;
import org.mybatis.generator.eclipse.tests.harness.summary.CompilationUnitSummary;

public class GeneratedCodeDeletingVisitorTest {
    ...
    public void testRegularClass() throws Exception {
        ...
        assertThat(visitor.getCompilationUnitType(), is(CompilationUnitType.CLASS));
    ...
    public void testRegularInterface() throws Exception {
        ...
        cu.accept(visitor);
        assertThat(visitor.getTypeDeclaration(), is(notNullValue()));
        assertThat(visitor.getCompilationUnitType(), is(CompilationUnitType.INTERFACE));
        assertThat(visitor.getTypeDeclaration().getName().getFullyQualifiedName(),
                is("AwfulTableMapper"));
